...
<head>
  <meta charset="UTF-8">
  <title>PHP: Convert Unicodes/Shortnames to Emoji One Images - Emoji One Labs</title>
...
<nav class="breadcrumbs">
  <div class="container">
    ...
    <a class="breadcrumb-item active" href="#">Convert Unicodes/Shortnames to Images</a>
  </div>
</nav>
...
<main>
  ...
  <div class="container">
    ...
    <h1>PHP: Convert Unicodes/Shortnames to Emoji One images</h1>

    <p>Convert emoji Unicode characters and shortnames to Emoji One Images or SVGs.</p>

    <div class="clearfix">
      <div class="column-1-2 input">
        <h3>Input:</h3>
        <form method="post" action="phptoimage.php#demo4">
          <input type="text" id="demo4-input" name="demo4-input" value="Hello world! :smile: &#x1f604;"/>
