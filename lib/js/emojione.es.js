...
export { ascii, asciiList, asciiRegexp, convert, emojiSize, emojiVersion, emojioneList, escapeHTML, escapeRegExp, greedyMatch, imagePathPNG, imageTitleTag, jsEscapeMap, jsEscapeMapGreedy, mapEmojioneList, mapUnicodeCharactersToShort, mapUnicodeToShort, memMapShortToUnicode, memMapShortToUnicodeCharacters, memorizeReplacement, objectFlip, regAscii, regShortNames, regUnicode, replaceAll, riskyMatchAscii, shortnameConversionMap, shortnameToAscii, shortnameToImage, shortnameToUnicode, shortnames, sprites, toImage, toShort, unescapeHTML, unicodeAlt, unicodeCharRegex, unicodeReplacementRegEx, unicodeToImage, unifyUnicode };
